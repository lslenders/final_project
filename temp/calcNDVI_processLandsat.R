...
## this function will take the NDVI from a list of tar files which is created by searching using the regular expression command. 
# The calculated NDVI's will be saved in the output folder.
